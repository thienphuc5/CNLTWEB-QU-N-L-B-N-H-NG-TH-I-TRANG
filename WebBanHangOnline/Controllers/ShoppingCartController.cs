...
namespace WebBanHangOnline.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public string UrlPayment(int TypePaymentVN, string orderCode)
        {
            ...
            vnpay.AddRequestData("vnp_Amount",Price.ToString()); // Số tiền thanh toán. Số tiền không mang các
            ...
            vnpay.AddRequestData("vnp_TxnRef", order.Code); // Mã tham chiếu của giao dịch tại hệ thống của merchant. Mã này là duy nhất

            // Add Params of 2.1.0 Version
            // Billing

            urlPayment = vnpay.CreateRequestUrl(vnp_Url, vnp_HashSecret);
            // log.InfoFormat("VNPAY URL: {0}", urlPayment);
